...

{
	...
	"3 : Close the application \n");
		...
		if(menuChoice==2) {
            ...
            String subMenu01=("1: Create a new file by creating new file directory \n"+
			...
			if (submenuChoice01==3) {
				...
				Scanner sc07 = new Scanner(System.in);
			      ...
			      String input03;
			      do {System.out.println("Enter the complete file name: ");
